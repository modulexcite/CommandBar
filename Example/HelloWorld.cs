	...
	public class HelloWorld : Form
	{
		...
		{
			this.enabledButton.Enabled = !this.enabledButton.Enabled;
		}
	
		private void ToggleVisible_Click(object sender, EventArgs e)
		{
			this.visibleButton.Visible = !this.visibleButton.Visible;
		}
		...
		private class Images
		{
			...
			static Images()
			{
				using (Stream stream = typeof(Images).Assembly.GetManifestResourceStream("ImageList16.png"))
				{
